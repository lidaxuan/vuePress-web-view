...
<a name="cXCtL"></a>
## MR
所有代码都应经过 mr 才能合并到 develop 分支<br />每一次 mr 只包含一个功能<br />每一次 mr 的文件不能过多<br />每一次 mr 的描述尽可能详细

<a name="sYOT2"></a>
## 分支管理

master   不能人为维护，通过 mr 维护<br />develop  由负责人维护<br />feat/xxx 由开发者维护，新功能开发完后提 mr, 然后视情况可以删除<br />fix         对已有功能进行 bug 修复
